...
var User = exports.User = function (_Resource) {
	...
	function User(client, id) {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(User).call(this, client, 'user', id));
	}
...
var UserCollection = exports.UserCollection = function (_Collection) {
	...
	function UserCollection(client) {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(UserCollection).call(this, client, 'users'));
	}
