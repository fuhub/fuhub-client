...
var Document = function (_Resource) {
  ...
  function Document(client, id) {
    ...
    return _possibleConstructorReturn(this, (Document.__proto__ || Object.getPrototypeOf(Document)).call(this, client, 'document', id));
  }
  ...
  _createClass(Document, [{
    ...
    value: function updateContent(text) {
      var contentType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _mimeType2.default.markdown;
