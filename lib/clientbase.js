...
var ClientBase = function (_EventEmitter) {
  ...
  _createClass(ClientBase, [{
    ...
    value: function fetch(path) {
      ...
      var qs = '';
      if (_lodash2.default.isObject(options.query)) {
        qs = '?' + _queryString2.default.stringify(options.query);
      }

      var url = this.absurl(path) + qs;
      var params = _extends({}, options, { headers: headers });
